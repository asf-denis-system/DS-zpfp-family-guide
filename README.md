...
- [ ] Карточки для Z1, Z4-Z7 (текст принципов уже в M3, карточки — следующий шаг)
...
| Артефакт | Что | Файлы |
|----------|-----|-------|
| [Карточки эпизодов](cards/) | MVP: Z2, Z0, Z3 полностью (18 карточек). Z1, Z4-Z7 — в guide/m3, карточки планируются | cards/ |
